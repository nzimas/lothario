Lothario is a mischievous quadraphonic expansion of Carter’s Delay for norns (https://github.com/williamthazard/carters-delay-norns). 

It keeps the original’s hands-on, granular delay workflow intact, but injects controlled chaos into every reflection. 
Each playback grain can be randomly transformed with pitch-shifting, ring modulation, sample-rate reduction, or bit-crushing—applied per reflection, not globally.
